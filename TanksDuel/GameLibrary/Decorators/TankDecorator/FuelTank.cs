...
{
    /// <summary>
    /// Класс танка с дополнительным топливом
    /// </summary>
    public class FuelTank : TankDecorator
    {
        private const int _boostValue = 300;
        private const int _maxFuelValue = 1000;

        /// <summary>
        /// Конструктор класса танка с дополнительным топливом
        /// </summary>
        public FuelTank(NormalTank tank) : base(tank) 
        {
            tank.Fuel += _boostValue;
        }
